  ...
  return (
    <>
      <div className="flex flex-col m ">
        ...
        />
        <ReactTypingEffect
          className="text-8xl pb-14 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-embie-orange-600 via-embie-yellow-600 to-embie-blue-light-600 font-poppins"
